...
pacman -S --noconfirm base bluez bluez-utils bluedevil efibootmgr git grub kitty linux linux-firmware linux-headers lvm2 neovim networkmanager sudo tesseract tesseract-data-eng plasma dolphin ark ristretto okular libreoffice-still
