...
pacman -S --noconfirm base bluez bluez-utils bluedevil efibootmgr git grub linux linux-firmware linux-headers lvm2 neovim networkmanager sudo plasma dolphin ark ristretto okular libreoffice-still
